...
func init() {
	...
	api := web.NewNamespace("/api",
		...
		// ImouAccessToken
		web.NSRouter("/monitor/getAccessToken", &controllers.MonitorController{}, "*:GetAccessToken"),
		// ImouKitToken
		//web.NSRouter("/monitor/getKitToken", &controllers.MonitorController{}, "*:GetKitToken"),
		// 获取指定图像采集设备的图片url
		web.NSRouter("/monitor/getSnapUrl", &controllers.MonitorController{}, "*:GetSnapUrl"),
		// upload
		//web.NSRouter("/monitor/upload", &controllers.MonitorController{}, "*:UploadToMinio"),
		// 测试抓拍
		web.NSRouter("/monitor/doSnap", &controllers.MonitorController{}, "*:DoSnap"),
		web.NSRouter("/monitor/getAllDeviceId", &controllers.MonitorController{}, "*:GetAllDeviceId"),
	)
